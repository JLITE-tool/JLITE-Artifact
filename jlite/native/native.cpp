...
JNIEXPORT void JNICALL Java_logger_Record_addConstructRecord
  (JNIEnv *jvmti_env, jclass klass, jlong addr, jint obj_typeid, jint line, jint class_name_id) {
    ConstructRecord<0> r;
    r.time = nanotime();
    r.addr = addr>>3;
    r.obj_typeid = obj_typeid;
...
JNIEXPORT void JNICALL Java_logger_Record_addUseRecord
  (JNIEnv *jvmti_env, jclass klass, jint type, jlong addr, jint line, jint class_name_id) {
    UseRecord<0> r;
    r.type = type;
    r.time = nanotime();
    r.addr = addr>>3;
